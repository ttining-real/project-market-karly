      ...
      <footer class='footer'>
          ...
          <article class='footer__about'>
            ...
            <div class='about__body'>
              ...
              <ul class='about__body-sns'>
                <li><a href='/' class='sns-blog' aria-label='블로그 바로가기'></a></li>
                <li><a href='/' class='sns-facebook' aria-label='페이스북 바로가기'></a></li>
                <li><a href='/' class='sns-instagram' aria-label='인스타그램 바로가기'></a></li>
                <li><a href='/' class='sns-post' aria-label='네이버 포스트 바로가기'></a></li>
                <li><a href='/' class='sns-youtube' aria-label='유튜브 바로가기'></a></li>
              </ul>
            </div>
          </article>
        ...
        <section class='footer__certification'>
          ...
          <ul class='certification__body'>
            <li>
              <button type='button' class='button-isms'>
                <span aria-label='isms 정보보호 관리체계 인증마크'></span>
                <p>[인증범위] 마켓칼리 쇼핑몰 서비스 개발 운영<br>(심사받지 않은 물리적 인프라 제외)<br>[유효기간] 2022.01.19 ~ 2025.01.18</p>
              </button>
            </li>
            <li>
              <button type='button' class='button-privacy'>
                <span aria-label='개인정보보호 우수 웹사이트·개인정보처리시스템 인증마크'></span>
                <p>개인정보보호 우수 웹사이트<br>개인정보처리시스템 인증 (ePRIVACY PLUS)</p>
              </button>
            </li>
            <li>
              <button type='button' class='button-toss'>
                <span aria-label='토스페이먼츠 로고'></span>
                <p>토스페이먼츠 구매안전(에스크로) 서비스를 이용하실 수 있습니다.</p>
              </button>
            </li>
            <li>
              <button type='button' class='button-woori'>
                <span aria-label='우리은행 로고'></span>
        ...
        <section class='footer__disclaimer'>
          ...
          <div class='disclaimer__body'>
            <p>마켓칼리에서 판매되는 상품 중에는 마켓칼리에 입점한 개별 판매자가 판매하는 마켓플레이스(오픈마켓) 상품이 포함되어 있습니다.<br>마켓플레이스(오픈마켓) 상품의 경우 칼리는 통신판매중개자로서 통신판매의 당사자가 아닙니다. 칼리는 해당 상품의 주문, 품질, 교환/환불 등 의무와 책임을 부담하지 않습니다.</p>
